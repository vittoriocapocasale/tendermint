...
type AppConnConsensus interface {
	...
	DeliverAllSync([]*types.RequestDeliverTx) error
...
func (app *appConnConsensus) DeliverAllSync(txs []*types.RequestDeliverTx) error {
	return app.appConn.DeliverAllSync(txs)
}
